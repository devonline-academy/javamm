...
package academy.devonline.javamm.interpreter.component.impl.model;
 ...
 */
public final class StackTraceItemImpl implements StackTraceItem {

    private final DeveloperFunction function;

    private final SourceLine invokeSourceLine;

    public StackTraceItemImpl(final DeveloperFunction function,
                              final SourceLine invokeSourceLine) {
    ...
    public int getSourceLineNumber() {
        return invokeSourceLine.getNumber();
    }
}
