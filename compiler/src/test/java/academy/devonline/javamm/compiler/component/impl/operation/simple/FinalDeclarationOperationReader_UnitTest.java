...
class FinalDeclarationOperationReader_UnitTest extends AbstractVarOrFinalDeclarationOperationReaderUnitTest {
    ...
    final OperationReader buildOperationReader(final VariableBuilder variableBuilder, final ExpressionResolver expressionResolver) {
        return new FinalDeclarationOperationReader(variableBuilder, expressionResolver);
    }
}